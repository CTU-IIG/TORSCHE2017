classdef problem < torsche.schedobj
    properties
        notation
        machines_type
        machines_quantity
    ...
    methods        
        function prob = problem(varargin)
            ...
            if nargin==3
                if isa(varargin{1},'torsche.problem') && ischar(varargin{2}) 
                ...
                prob.notation = notation;
                prob.machines_type = machines_type;
                prob.machines_quantity = machines_quantity;
                prob.betha = betha;
