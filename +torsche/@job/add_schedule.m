...
if sum(strcmpi(varargin{1},{'description', 'time', 'iteration', 'memory', 'period'})) >= 1
    ...
    % Add schedule
    TASKSET.parent.schedule.desc = varargin{1};
    ...
    if ni >= 3
        ...
        for i=1:size(start,2)
            ...
            TASKSET.parent.tasks(i)=add_scht(TASKSET.parent.tasks(i),start{i},lenght{i},procesor_for_task);
        end
    end
end
